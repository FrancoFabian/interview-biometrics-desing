...
export function Sidebar({ isOpen, onClose }: SidebarProps) {
  ...
  return (
    <>
      ...
      <aside className={`sidebar ${isOpen ? "open" : ""}`} role="navigation" aria-label="Menú de navegación">
        <div className="sidebar-header">
          <span className="sidebar-header-title">Menú de navegación</span>
        </div>
              ...
              <ul className="sidebar-menu">
                {section.items.map((item) => (
                  <li key={item.id} className="sidebar-menu-item">
                    <a href={item.href} className={`sidebar-menu-link ${item.active ? "active" : ""}`}>
